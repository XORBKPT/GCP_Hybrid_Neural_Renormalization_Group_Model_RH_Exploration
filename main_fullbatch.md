...
This version uses sparse matrices to handle N=10,000+ nodes in a single
batch, suitable for high-memory GPU instances (e.g., GCP A100).

It includes all physics-informed losses:
1. MSE (Accuracy)
